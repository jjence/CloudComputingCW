...
export default function about()  {
    ...
    return (
        <section className="py-14">
            <img src="https://webassets.cdn.ignitetravel.com/ignitetravel.com/wp-content/uploads/2017/01/13104049/MyHoliday_Tropical-Turquoise-RGB-BIG-434px.png" width={300} className="mx-auto" />
            <div className="max-w-screen-xl mx-auto mt-5 px-4 text-center md:px-8">
                <div className="max-w-xl mx-auto">
                    <h3 className="text-gray-800 text-3xl font-semibold sm:text-4xl">
                        Meet our Team
                    </h3>
                    <p className="text-gray-600 mt-3">
                        We are proud of our extremely dedicated and talented team that strives to achieve perfection
                    </p>
                </div>
                <div className="mt-12">
