        ...
        <main className="w-full flex">
            <div className="relative flex-1 hidden items-center justify-center h-screen bg-gray-900 lg:flex">
                <div className="relative z-10 w-full max-w-md">
                    <a href="/" className="flex items-center px-4 py-2 text-gray-200 rounded-md shadow-md block sm:w-auto">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
                            <path fillRule="evenodd" d="M18 10a.75.75 0 01-.75.75H4.66l2.1 1.95a.75.75 0 11-1.02 1.1l-3.5-3.25a.75.75 0 010-1.1l3.5-3.25a.75.75 0 111.02 1.1l-2.1 1.95h12.59A.75.75 0 0118 10z" clipRule="evenodd" />
                        </svg>
                        Back
                    </a>
                    <img src="https://webassets.cdn.ignitetravel.com/ignitetravel.com/wp-content/uploads/2017/01/13104049/MyHoliday_Tropical-Turquoise-RGB-BIG-434px.png" width={250} />
                    <div className=" mt-16 space-y-3">
                        <h3 className="text-white text-3xl font-bold">Start sleeping with an ease of mind</h3>
            ...
            <div className="flex-1 flex items-center justify-center h-screen">
                <div className="w-full max-w-2xl space-y-11 px-4 bg-white text-gray-600 sm:px-0">
                    <div className="">
                        <div className="mt-6 space-y-2 ml-10">
                    ...
                    <div className="grid grid-cols-1">
                        <button onClick={() => signIn('google')} className="flex items-center justify-center w-1/2 mx-auto py-2.5 border rounded-lg hover:bg-gray-50 duration-150 active:bg-gray-100">
                    ...
                    <form
                        ...
                        className="space-y-5 ml-20 mr-20"
                    >
                        <div>
                        ...
                        <button
                            className="w-1/2 ml-40 px-4 py-2 text-white font-medium bg-indigo-600 hover:bg-indigo-500 active:bg-indigo-600 rounded-lg duration-150">
                            Create account
                        </button>
                    </form>
                </div>
