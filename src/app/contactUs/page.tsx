...
export default function contact()  {
    ...
    const contactMethods = [
        ...
        },
        {
            ...
            ,
            contact: "customersupport@myHoliday.com",
            title: "Email"
        },
    ]
            ...
            <div className="relative z-10 max-w-screen-xl mx-auto text-gray-600 sm:px-4 md:px-8">
                <div className="max-w-lg space-y-3 px-4 sm:mx-auto sm:text-center sm:px-0">
                    ...
                    <p className="text-gray-300">
                        We’re here to help and answer any questions you might have, please contact us through one of the options below
                    </p>
                </div>
                <div>
                    <ul className="mt-12 flex flex-wrap gap-x-12 gap-y-6 items-center justify-center lg:gap-x-24">
                        {
                            contactMethods.map((item, idx) => (
                                <li key={idx}>
                                    <h4 className="text-white text-lg font-medium underline">{item.title}</h4>
